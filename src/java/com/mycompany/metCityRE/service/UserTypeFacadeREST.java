...
import com.mycompany.metCityRE.UserType;
 ...
 */
@Stateless
@Path("com.mycompany.metcityre.usertype")
public class UserTypeFacadeREST extends AbstractFacade<UserType>
{

    @PersistenceContext(unitName = "MetCityREPU")
    private EntityManager em;

    public UserTypeFacadeREST()
    {
